...
class IngredientDataHost {
    ...
    fun showAllIngredientData(): List<MyIngredientData>{
        ...
        ingredDatas.apply {
            add(IngredientData(uri, "쌀", "grain", "g", 22))
            add(IngredientData(uri, "보리", "grain", "g", 23))
            add(IngredientData(uri, "밀가루", "grain", "g", 24))
            add(IngredientData(uri, "옥수수", "grain", "g", 25))
            add(IngredientData(uri, "콩", "grain", "g", 26))
            add(IngredientData(uri, "면", "grain", "g", 27))
        }

        uri = getUriForResource(R.drawable.icon_vegetable)
        ingredDatas.apply {
            add(IngredientData(uri, "양파", "vegetable", "개", 28))
            add(IngredientData(uri, "마늘", "vegetable", "개", 29))
            add(IngredientData(uri, "당근", "vegetable", "개", 30))
            add(IngredientData(uri, "오이", "vegetable", "개", 31))
            add(IngredientData(uri, "배추", "vegetable", "개", 32))
            add(IngredientData(uri, "파", "vegetable", "개", 33))
            add(IngredientData(uri, "고추", "vegetable", "개", 34))
            add(IngredientData(uri, "깻잎", "vegetable", "개", 35))
            add(IngredientData(uri, "상추", "vegetable", "개", 36))
            add(IngredientData(uri, "콩나물", "vegetable", "개", 37))
            add(IngredientData(uri, "버섯", "vegetable", "개", 38))
            add(IngredientData(uri, "무", "vegetable", "개", 39))
            add(IngredientData(uri, "브로콜리", "vegetable", "개", 40))
            add(IngredientData(uri, "피망", "vegetable", "개", 41))
            add(IngredientData(uri, "감자", "vegetable", "개", 42))
        }

        uri = getUriForResource(R.drawable.icon_fruit)
        ingredDatas.apply {
            add(IngredientData(uri, "사과", "fruit", "개", 43))
            add(IngredientData(uri, "배", "fruit", "개", 44))
            add(IngredientData(uri, "바나나", "fruit", "개", 45))
            add(IngredientData(uri, "토마토", "fruit", "개", 46))
        }

        uri = getUriForResource(R.drawable.icon_sauce)
        ingredDatas.apply {
            add(IngredientData(uri, "간장", "sauce", "g", 47))
            add(IngredientData(uri, "고추장", "sauce", "g", 48))
            add(IngredientData(uri, "된장", "sauce", "g", 49))
            add(IngredientData(uri, "소금", "sauce", "g", 50))
            add(IngredientData(uri, "설탕", "sauce", "g", 51))
            add(IngredientData(uri, "토마토 소스", "sauce", "g", 52))
            add(IngredientData(uri, "식초", "sauce", "g", 53))
            add(IngredientData(uri, "참기름", "sauce", "g", 54))
            add(IngredientData(uri, "들기름", "sauce", "g", 55))
            add(IngredientData(uri, "초고추장", "sauce", "g", 56))
            add(IngredientData(uri, "물엿", "sauce", "g", 57))
            add(IngredientData(uri, "고춧가루", "sauce", "g", 58))
            add(IngredientData(uri, "돈까스 소스", "sauce", "g", 59))
            add(IngredientData(uri, "케찹", "sauce", "g", 60))
            add(IngredientData(uri, "머스타드", "sauce", "g", 61))
            add(IngredientData(uri, "후추", "sauce", "g", 62))
        }
